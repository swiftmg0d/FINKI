...
//Во првиот ред од влезот даден е бројот на јазли во листата N,
...
public class PalindromeDLL {
    ...
    public static int isItPalindrome(DLL<Integer> list){
        DLLNode<Integer>lNode=list.getLast();
        DLLNode<Integer>fNode=list.getFirst();
        while (lNode!=null && fNode!=null){
            if(fNode.element!=lNode.element)return -1;
            fNode=fNode.succ; lNode=lNode.pred;
        }
        return 1;
    }
