...
//            sort(int[] a)
    ...
    class IntegerArray {
        private final int []arrA;

        public IntegerArray(int[] arrA) {
            this.arrA = arrA;
        }
        ...
        IntegerArray getSorted(){
            return new IntegerArray(Arrays.stream(arrA).sorted().toArray());
        }



        IntegerArray concat(IntegerArray ia){
            return new IntegerArray(IntStream.concat(Arrays.stream(arrA),Arrays.stream(ia.arrA)).toArray());
        }
        @Override
        ...
        double average(){
            return Arrays.stream(arrA).average().getAsDouble();
        }
       ...
       public boolean equals(Object o) {
           ...
           return Arrays.equals(arrA, that.arrA);
       }

        @Override
        public int hashCode() {
            return Arrays.hashCode(arrA);
        }
    }
    class ArrayReader {
