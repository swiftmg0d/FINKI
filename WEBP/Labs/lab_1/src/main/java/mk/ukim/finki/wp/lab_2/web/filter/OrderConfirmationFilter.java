package mk.ukim.finki.wp.lab_2.web.filter;
...
@WebFilter(filterName = "OrderConfirmationFilter", urlPatterns = {"/ticketConfirmation"},
        initParams = @WebInitParam(name = "ignore-path",value = "/ticketConfirmation"))
public class OrderConfirmationFilter implements Filter {
    ...
    public void doFilter(ServletRequest servletRequest, ServletResponse servletResponse, FilterChain filterChain) throws IOException, ServletException {
        ...
        if(ignorePath.startsWith(path)  && ticketOrder!=null){
            ...
            httpServletResponse.sendRedirect("/movies");
        }
